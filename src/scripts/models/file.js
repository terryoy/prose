...
module.exports = Backbone.Model.extend({
  ...
  initialize: function(attributes, options) {
    ...
    this.set({
      ...
      'content': this.isNew() && isUndefined(attributes.content) ? t('main.new.body') : attributes.content,
  ...
  clone: function(attributes, options) {
    ...
    return new this.constructor(extend(pick(this.attributes, [
      'branch',
      'collection',
      'content',
      'metadata',
  ...
  fetch: function(options) {
    ...
    if (this.isNew()) {
      ...
      Backbone.Model.prototype.fetch.call(this, omit(options, 'success', 'error', 'complete'));

...
module.exports = Backbone.View.extend({
  ...
  initialize: function(options) {
    ...
    bindAll(this, ['updateModel', 'setValue', 'exit', 'remove']);
  },
  ...
  getValue: function() {
    ...
    chain(this.subviews).map(function(view) {
      return {
        value: view.getValue(),
        name: view.name
      };
  ...
  refresh: function() {
    forEach(this.codeMirrorInstances, function(codeMirror) {
      codeMirror.refresh();
    });
  },
